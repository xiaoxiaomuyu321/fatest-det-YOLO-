...
if __name__ == '__main__':
    ...
    parser.add_argument('--weight', type=str, default='runs/train/exp11/best.pth', help='.weight config')
    parser.add_argument('--img', type=str, default='datasets/apricot/images/train/IMG_20240501_094927_4.jpg', help='The path of test image')
